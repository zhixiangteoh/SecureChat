/* 
This program tests the SymCipher interface and the two implementations Substitute and Add128.
*/
...
public class SymCipherTest {
	public static void main(String[] args) {
		...
		String test1 = new String(
				"abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuzwxyzABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ012345678901234567890123");
